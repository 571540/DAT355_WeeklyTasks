...
import stateMachine.xtext.mydsl.formatting2.MyDslFormatter;
import stateMachine.xtext.mydsl.generator.MyDslGenerator;
import stateMachine.xtext.mydsl.parser.antlr.MyDslAntlrTokenFileProvider;
import stateMachine.xtext.mydsl.parser.antlr.MyDslParser;
import stateMachine.xtext.mydsl.parser.antlr.internal.InternalMyDslLexer;
import stateMachine.xtext.mydsl.scoping.MyDslScopeProvider;
import stateMachine.xtext.mydsl.serializer.MyDslSemanticSequencer;
import stateMachine.xtext.mydsl.serializer.MyDslSyntacticSequencer;
import stateMachine.xtext.mydsl.services.MyDslGrammarAccess;
import stateMachine.xtext.mydsl.validation.MyDslConfigurableIssueCodesProvider;
import stateMachine.xtext.mydsl.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "stateMachine/xtext/mydsl/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("stateMachine.xtext.mydsl.MyDsl");
	}
