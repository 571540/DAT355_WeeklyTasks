 ...
 */
package stateMachine.xtext.mydsl.services;
...
public class MyDslGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class StateMachineElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "stateMachine.xtext.mydsl.MyDsl.StateMachine");
	...
	public class StateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "stateMachine.xtext.mydsl.MyDsl.State");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cStateKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cNameIDTerminalRuleCall_1_0 = (RuleCall)cNameAssignment_1.eContents().get(0);
		private final Keyword cInKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Assignment cIncommingAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final CrossReference cIncommingTransitionCrossReference_3_0 = (CrossReference)cIncommingAssignment_3.eContents().get(0);
		private final RuleCall cIncommingTransitionQualifiedNameParserRuleCall_3_0_1 = (RuleCall)cIncommingTransitionCrossReference_3_0.eContents().get(1);
		...
		//State:
		//	'state' name=ID
		//	'in' incomming+=[Transition|QualifiedName]
		...
		//incomming+=[Transition|QualifiedName]
		public Assignment getIncommingAssignment_3() { return cIncommingAssignment_3; }
		
		//[Transition|QualifiedName]
		public CrossReference getIncommingTransitionCrossReference_3_0() { return cIncommingTransitionCrossReference_3_0; }
		
		//QualifiedName
		public RuleCall getIncommingTransitionQualifiedNameParserRuleCall_3_0_1() { return cIncommingTransitionQualifiedNameParserRuleCall_3_0_1; }
	...
	public class TransitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "stateMachine.xtext.mydsl.MyDsl.Transition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TimeEventElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "stateMachine.xtext.mydsl.MyDsl.TimeEvent");
	...
	public class QualifiedNameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "stateMachine.xtext.mydsl.MyDsl.QualifiedName");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EIntElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "stateMachine.xtext.mydsl.MyDsl.EInt");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("stateMachine.xtext.mydsl.MyDsl".equals(grammar.getName())) {
				return grammar;
			}
