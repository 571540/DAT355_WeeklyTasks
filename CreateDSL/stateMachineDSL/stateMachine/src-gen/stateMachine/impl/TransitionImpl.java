 ...
 *   <li>{@link stateMachine.impl.TransitionImpl#getTimer <em>Timer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends NamedElementImpl implements Transition {
	...
	public void setTarget(State newTarget) {
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this, StateMachinePackage.STATE__INCOMMING,
						State.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject) newTarget).eInverseAdd(this, StateMachinePackage.STATE__INCOMMING,
						State.class, msgs);
	...
	public void setSource(State newSource) {
		if (newSource != source) {
			NotificationChain msgs = null;
			if (source != null)
				msgs = ((InternalEObject) source).eInverseRemove(this, StateMachinePackage.STATE__OUTGOING, State.class,
						msgs);
			if (newSource != null)
				msgs = ((InternalEObject) newSource).eInverseAdd(this, StateMachinePackage.STATE__OUTGOING, State.class,
						msgs);
	...
	public NotificationChain basicSetTimer(TimeEvent newTimer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StateMachinePackage.TRANSITION__TIMER, oldTimer, newTimer);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newTimer != timer) {
			...
			if (timer != null)
				msgs = ((InternalEObject) timer).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StateMachinePackage.TRANSITION__TIMER, null, msgs);
			if (newTimer != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StateMachinePackage.TRANSITION__TIMER, newTimer,
					newTimer));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case StateMachinePackage.TRANSITION__TIMER:
