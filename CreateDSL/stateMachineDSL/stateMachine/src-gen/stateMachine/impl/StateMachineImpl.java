...
public class StateMachineImpl extends NamedElementImpl implements StateMachine {
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StateMachinePackage.STATE_MACHINE__START,
							oldStart, start));
			}
		}
		return start;
	...
	public void setStart(State newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateMachinePackage.STATE_MACHINE__START, oldStart,
					start));
	}
