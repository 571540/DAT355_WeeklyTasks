		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_State_incomming_feature",
								"_UI_State_type"),
						StateMachinePackage.Literals.STATE__INCOMMING, true, false, true, null, null, null));
	}
	...
	protected void addOutgoingPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						StateMachinePackage.Literals.STATE__OUTGOING, true, false, true, null, null, null));
	}
