 ...
 */
package stateMachine.xtext.mydsl.ui.contentassist;
...
public abstract class AbstractMyDslProposalProvider extends TerminalsProposalProvider {
	...
	public void completeState_Incomming(EObject model, Assignment assignment, ContentAssistContext context, ICompletionProposalAcceptor acceptor) {
		lookupCrossReference(((CrossReference)assignment.getTerminal()), context, acceptor);
	}
